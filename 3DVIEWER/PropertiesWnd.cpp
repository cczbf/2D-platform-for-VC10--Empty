...
int CPropertiesWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_dlgCTestPanel.Create(IDD_TEST_PANEL, this);
...
void CPropertiesWnd::OnSetFocus(CWnd* pOldWnd)
{
	...
	//m_wndPropList.SetFocus(); //zbf20160308
}
...
void CPropertiesWnd::OnPaint()
{
	...
	CBrush CBrushBkg;
	CBrushBkg.CreateSolidBrush(RGB(240,240,240));

	CRect rectClient;
	GetClientRect(rectClient);
	dc.FillRect(&rectClient, &CBrushBkg);
}

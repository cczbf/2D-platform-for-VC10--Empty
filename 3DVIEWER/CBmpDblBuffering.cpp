...
//#define DisplayWidth 2880
//#define DisplayHeight 1800
#define DisplayWidth (2880*2)
#define DisplayHeight (1800*2)
...
//		m_hBmpBackBuf	= CreateCompatibleBitmap( hDC, 1024,1024 ); 
		m_hBmpBackBuf	= CreateCompatibleBitmap( hDC, DisplayWidth,DisplayHeight );  //zbf20160401
		ReleaseDC( NULL, hDC ); 
	}
...
//			NULL,  0,0, WHITENESS);
	BitBlt(		m_hMemDC, 0,0,  DisplayWidth,DisplayHeight,   //zbf20160401
    				NULL,  0,0, WHITENESS);
...
//			m_hMemDC,  0,0, SRCCOPY);
	...
	BitBlt( m_hDestDC, 0,0, DisplayWidth, DisplayHeight,   //zbf20160401
			   m_hMemDC,  0,0, SRCCOPY);
